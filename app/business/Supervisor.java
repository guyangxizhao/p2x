...
public class Supervisor implements Serializable{
	private static final long serialVersionUID = -8401891858163911741L;
	public long id;
	private long _id = -1;
	...
	public String getKeySign() {
		...
		String sign = com.shove.security.Encrypt.MD5(DesId + time + Constants.ENCRYPTION_KEY,Charset.forName("utf-8"));
		return sign;
	}
	...
	public void setPassword(String password) {
		_password = com.shove.security.Encrypt.MD5(password + Constants.ENCRYPTION_KEY,Charset.forName("utf-8"));
	}
	...
	public static String checkUkey(String userName, String password, String sign, String keyTime, ErrorInfo info){
        ...
        String MD5pass = com.shove.security.Encrypt.MD5(password2 + Constants.ENCRYPTION_KEY,Charset.forName("utf-8"));

		//把传过来的userName，password，time 用MD5加密验证签名
		String sign2 = com.shove.security.Encrypt.MD5(all.trim(),Charset.forName("utf-8"));
	...
	public int login(String password, ErrorInfo error) {
		 ...
		 * 密码错误
		 */
		if (StringUtils.isNotBlank(this.password) && !this.password.equals(com.shove.security.Encrypt.MD5(password + Constants.ENCRYPTION_KEY,Charset.forName("utf-8")))) {
			/*
...
//		}
	...
	public boolean isMyPassword(String password) {
		...
		password = com.shove.security.Encrypt.MD5(password+Constants.ENCRYPTION_KEY,Charset.forName("utf-8"));
	...
	public static int resetPassword(long supervisorId, ErrorInfo error) {
		...
		String password = com.shove.security.Encrypt.MD5(Constants.SUPERVISOR_INITIAL_PASSWORD + Constants.ENCRYPTION_KEY,Charset.forName("utf-8"));
