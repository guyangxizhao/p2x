...
public class OverBorrow implements Serializable{
	private static final long serialVersionUID = -4207925013066911469L;
	public long id;
	public long _id = -1;
	...
	public int applyFor(User user, int amount, String reason, List<Map<String,String>> auditItems, ErrorInfo error) {
		...
		user.balance = Double.parseDouble(record[0].toString());
		user.balance2 = Double.parseDouble(record[1].toString());
