...
public class TemplateEmail implements Serializable{
	private static final long serialVersionUID = 4430257131760367126L;
	public long id;
	private long _id;
	 ...
	 * @param error
	 */
	public static void verificationEmail(User user, ErrorInfo error) {
		error.clear();
		...
		BackstageSet backstageSet = BackstageSet.getCurrentBackstageSet();
		String sign = Security.addSign(user.id, Constants.ACTIVE);
		String url = Constants.VER_EMAIL+ sign;
