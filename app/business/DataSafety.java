...
public class DataSafety implements Serializable{
	private static final long serialVersionUID = -4969620652469682616L;
	public long id;
	private long _id;
	...
	public boolean signCheck(ErrorInfo error){
		...
		String userSign1 = com.shove.security.Encrypt.MD5(Long.toString(this._id) + this.balance1 + this.freeze1 + Constants.ENCRYPTION_KEY,Charset.forName("utf-8"));
		
		String userSign2 = com.shove.security.Encrypt.MD5(Long.toString(this._id) + this.balance2 + 
				this.freeze2 + this.amount + this.recieveAmount + Constants.ENCRYPTION_KEY,Charset.forName("utf-8"));
