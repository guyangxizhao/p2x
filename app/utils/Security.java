...
public class Security {
	...
	public static String addSign(long id, String action) {
		...
		String md5=com.shove.security.Encrypt.MD5(des+Constants.ENCRYPTION_KEY,Charset.forName("utf-8"));
	...
	public static String encryCookie(String  sessionId , String action) {
		...
		String sign=com.shove.security.Encrypt.MD5(val+Constants.ENCRYPTION_KEY,Charset.forName("utf-8")).toUpperCase();
	...
	public static long decryCookie(String encryCookie,String action, ErrorInfo error) {
		...
		String md5 = com.shove.security.Encrypt.MD5(des + Constants.ENCRYPTION_KEY,Charset.forName("utf-8")).toUpperCase();
