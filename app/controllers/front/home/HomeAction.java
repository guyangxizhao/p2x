...
public class HomeAction extends BaseController{
	...
	public static void home(){
		...
		String currMonth = ("0" + DateUtil.getMonth()).replaceFirst("^0(?=\\d{2})", "");
		
		render(homeAds, bidList,agencyBids,investBillboard,successStorys,investSkills,loanSkills,news, 
				bids, adsEnsure, adsPartner, types ,maps, currMonth);
	}
	...
	public static void aboutUs(int id){
		...
		render(contentList, investData, products, creditLevels, parent, types, id);
	}
