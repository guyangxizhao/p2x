...
public class PaymentAction extends BaseController {
	...
	public static void registerSubjectCB(String pMerCode, String pErrCode, String pErrMsg, String p3DesXmlPara, String pSign) {
		...
		/*标的新增不要返回错误信息*/
		if (!"MG02500F".equals(pErrCode) && !"MG00000F".equals(pErrCode)) {
			flash.error(pErrMsg);
		}
		...
		if (IPSConstants.BID_CREATE.equals(operation)) {
			...
			if(bid.id > 0){
				...
				flash.put("status", JPAUtil.getJSONObject(error, "select status from t_bids where id = ?", bid.id).getInt("status"));
	...
	public static void registerCreditorCB(String pMerCode, String pErrCode, String pErrMsg, String p3DesXmlPara, String pSign) {
		...
		String showBox = Encrypt.encrypt3DES(Constants.SHOW_BOX, bidId + Constants.ENCRYPTION_KEY, Charset.forName("utf-8"));
	...
	public static void registerCreditorCBSys(String pMerCode, String pErrCode, String pErrMsg, String p3DesXmlPara, String pSign) {
		...
		String pPostUrl = BaseController.getBaseURL() + IPSPostUrl.UNFREEZE_INVEST_AMOUNT;
		if(resultJson == null) {
			resultJson = new JSONObject();
			pPostUrl = BaseController.getBaseURL() + IPSPostUrl.REGISTER_CREDITOR;
		}
	...
	public static void registerCreditorPost(String result) {
		...
		result = Encrypt.decrypt3DES(result, Constants.ENCRYPTION_KEY, Charset.forName("utf-8"));
	...
	public static void autoNewSigningCB(String pMerCode, String pErrCode, String pErrMsg, String p3DesXmlPara, String pSign) {
		...
		if (StringUtils.isNotBlank(p3DesXmlPara)) {
			p3DesXmlPara = Encrypt.decrypt3DES(p3DesXmlPara, Constants.ENCRYPTION_KEY, Charset.forName("utf-8"));
		}
	...
	public static void doDpTradeCBSys(String pMerCode, String pErrCode, String pErrMsg, String p3DesXmlPara, String pSign) {
		...
		resultJson.put("pPostUrl", BaseController.getBaseURL() + IPSPostUrl.DO_DP_TRADE);
...
//				Bid bid = (Bid) Cache.get(pMerBillNo)
	...
	public static void repaymentNewTradeCBSys(String pMerCode, String pErrCode, String pErrMsg, String p3DesXmlPara, String pSign) {
		...
		resultJson.put("code", error.code);
		resultJson.put("msg", error.msg);
		resultJson.put("pPostUrl", BaseController.getBaseURL() + IPSPostUrl.REPAYMENT_NEW_TRADE);
	...
	public static void doDwTradeCBSys(String pMerCode, String pErrCode, String pErrMsg, String p3DesXmlPara, String pSign) {
		...
		resultJson.put("code", error.code);
		resultJson.put("msg", error.msg);
		resultJson.put("pPostUrl", BaseController.getBaseURL() + IPSPostUrl.DO_DW_TRADE);
	...
	public static void transferUserToMerCB(String pMerCode, String pErrCode, String pErrMsg, String p3DesXmlPara, String pSign) {
		...
		Logger.info("p3DesXmlPara:%s", Encrypt.decrypt3DES(p3DesXmlPara, Constants.ENCRYPTION_KEY), Charset.forName("utf-8"));
	...
	public static void userBindCard(){
		...
		Map<String, String> args = Payment.userBindCard();
	 ...
	 * 用户绑卡(同步回调)
	 */
	public static void userBindCardCB(){
		// nothing
	}
	 ...
	 * 用户绑卡（异步回调）
	 */
	public static void userBindCardCBSys(String pMerCode, String pErrCode, String pErrMsg, String p3DesXmlPara, String pSign) {
		ErrorInfo error = new ErrorInfo();
		Logger.info("用户绑卡异步回调："
				+ "pMerCode：" + pMerCode
				+ "pErrCode：" + pErrCode
				+ "pErrMsg：" + pErrMsg
				+ "p3DesXmlPara：" + p3DesXmlPara
				+ "pSign：" + pSign);
