...
public class UserBidAction  extends SupervisorController{
	...
	public static void repaymentingList() {
		...
		pageBean.page = Bid.queryBidRepaymenting(0,pageBean, Supervisor.currSupervisor().id, error, BidPlatformAction.getParameter(pageBean, null));
	...
	public static void repaymentList() {
		...
		pageBean.page = Bid.queryBidRepayment(0,pageBean, Supervisor.currSupervisor().id, error, BidPlatformAction.getParameter(pageBean, null));
	...
	public static void badList() {
		...
		pageBean.page = Bid.queryBidBad(0,pageBean, Supervisor.currSupervisor().id, error, BidPlatformAction.getParameter(pageBean, null));
	...
	public static void repaymentingListToDep() {
		ErrorInfo error = new ErrorInfo();
		PageBean<v_bid_repaymenting> pageBean = new PageBean<v_bid_repaymenting>();
		pageBean.page = Bid.queryBidRepaymenting(0,pageBean, 0, error, BidPlatformAction.getParameter(pageBean, null));
