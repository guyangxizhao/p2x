...
public class LoginAction extends BaseController {
	...
	public static void login(String name, String password, String captcha, String randomID, String city, String flag) {
	   ...
	   if(null != bottomLinks){
		...
		long adminId = Supervisor.queryAdminId(name, com.shove.security.Encrypt.MD5(password + Constants.ENCRYPTION_KEY,Charset.forName("utf-8")), error);
		String time = Long.toString(new DateUtil().getHours());
		String flag2 = com.shove.security.Encrypt.MD5(Long.toString(adminId) + time,Charset.forName("utf-8"));
...
//		}
	...
	public static void logout() {
		...
		redirect(Router.reverse("supervisor.login.LoginAction.login").url);
	}
