...
//		}
	...
	public static String TwoDimensionalCode(Map<String, String> parameters) throws IOException{
		...
		jsonMap.put("spreadLing", user.spreadLink);
	...
	public static String queryMyLoanBills(Map<String, String> parameters) throws IOException{
		...
		PageBean<v_bill_loan> page = Bill.queryMyLoanBills(userId,0, payType, isOverType, keyType, key, Integer.valueOf(parameters.get("currPage")), Constants.APP_PAGESIZE, error);
