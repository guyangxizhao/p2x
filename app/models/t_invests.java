...
public class t_invests extends Model {
	private static final long serialVersionUID = -1696775055435109465L;
	public long user_id;
	public Date time;
	...
	public t_invests(long id,double amount, double correct_interest){
		this.id=id;
		this.amount=amount;
		this.correct_interest = correct_interest;
	}
