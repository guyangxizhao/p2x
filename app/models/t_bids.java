...
public class t_bids extends Model {
	private static final long serialVersionUID = 1167595744195986678L;
	public long user_id;
	public Date time;
	...
	public t_bids(long id,String title, double amount, int period, double apr,
			int status, double loan_schedule, double has_invested_amount,
			int period_unit) {
		super();
		this.id=id;
		this.title = title;
