...
public class IPSConstants {
	 ...
	 * 所有资金托管支付接口id
	 */
	public static final int GATE_WAY_GUO = 1;  //国付宝
	public static final int GATE_WAY_IPS = 2;  //环迅
	public static final int GATE_WAY_LOAN = 3;  //双乾
	public static final int GATE_WAY_PNR = 4;  //汇付
	public static final int GATE_WAY_YEE = 5;  //易宝
	
	/**
	 * 当前支付网关
	 */
	public static int CurrentGateWay = 0;  //默认为0，非资金托管
