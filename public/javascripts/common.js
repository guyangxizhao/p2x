 ...
 */
function uploadImage(fileElementId, imageElementId,valueElementId) {
	...
	//var ac= #{jsAction@{FileUpload.uploadImage(':imgFile')/}}
	$.ajaxFileUpload({
		...
		success : function(data) {
			...
			$("#" + imageElementId).attr("src",http_path+data.filename);
			
			if(typeof(valueElementId) != "undefined" || valueElementId != "" ){
				$("#" + valueElementId).val(data.filename);
			}
		},
 ...
 * @param imageElementId
 */
function uploadImageType(fileElementId, imageElementId,valueElementId) {
	var path = $("#" + fileElementId).val();
...
function getCreditStyle(creditName) {
	var colors = {
		AA: 'bg-green',
		A: 'bg-lightGreen',
		B: 'bg-blue',
	...
	if (colors[creditName])
		return colors[creditName];
	return 'bg-orange';
}